...
RotationState::RotationState(const Matrix3D& transform): t(transform){
...
int tri_tri_intersect(float* V0,float* V1,float* V2,
...
bool Triangle::intersect(const Triangle& t) const {
  return (tri_tri_intersect((float*)&v1.x, (float*)&v2.x,
                            (float*)&v3.x, (float*)&t.v1.x,
                            (float*)&t.v2.x, (float*)&t.v3.x) != 0);
}
